...
export default function NavActions() {
  ...
  return (
    <div className="nav-right">
      ...
      <Link href="/auth/sign-up" prefetch={false} className="btn-launch" style={{textDecoration:'none'}}>Launch App</Link>
      ...
      {mobileMenuOpen && (
        <div className="mobile-menu">
          ...
          <Link href="/auth/sign-up" prefetch={false} className="mobile-menu-launch" style={{textDecoration:'none'}} onClick={() => setMobileMenuOpen(false)}>
            Launch App →
          </Link>
        </div>
      )}
